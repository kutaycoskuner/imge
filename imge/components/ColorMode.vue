...
// reactive data
const themeColors = ref(['system', 'light', 'dark', 'sepia']);
...
----------------------------------------------------------------------- -->
<template>
    <div class="ncolor-mode">
        <div v-if="$colorMode.value == 'light'" class="light-mode" @click="toggleColorMode('light')">
        ...
        <div v-if="$colorMode.value == 'dark'" class="dark-mode" @click="toggleColorMode('dark')">
            <!-- <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
        ...
        <div v-if="$colorMode.value == 'sepia'" class="sepia-mode" @click="toggleColorMode('sepia')">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 26 26" stroke-width="1.5"
                stroke="currentColor" class="w-6 h-6">
                <path stroke-linecap="round" stroke-linejoin="round"
